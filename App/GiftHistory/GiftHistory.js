        ...
        <View style={styles.listbox}>
            ...
            <View style={styles.userdetailtext}>
                <View style={styles.usernametext}>
                    ...
                    <Text style={styles.donatedamount}>  Donated $5.00</Text>
                </View>
        ...
        <Image style = {styles.backgroundImage} source = {images.background}>
            ...
            <View style={styles.donationdetailsbox}>
                <View style={styles.detailscontainer}>
                    ...
                    <Text style={styles.detailsheading}>Total Received</Text>
                ...
                <View style={styles.detailscontainersecond}>
                    ...
                    <Text style={styles.detailsheading}>Total Sent</Text>
                    <View style={{flexDirection:'row'}}>
                ...
                <View style={styles.detailscontainersecond}>
                    ...
                    <Text style={styles.detailsheading}>Total Donations</Text>
                    <View style={{flexDirection:'row'}}>
                        ...
                        <View style={styles.listbox}>
                            ...
                            <View style={styles.userdetailtext}>
                                <View style={styles.usernametext}>
                                    ...
                                    <Text style={styles.pendingamount}>  Sent $5.00(Pending Reciept)</Text>
                                </View>
                                <Text style={styles.pendingamount}>August 11, 2016</Text>
                            </View>
                        </View>
                        <View style={styles.listbox}>
                            ...
                            <View style={styles.userdetailtext}>
                                <View style={styles.usernametext}>
                                    ...
                                    <Text style={styles.recievedamount}>  Recieved $5.00</Text>
                                </View>
